...
function HowItWorksSection() {
  useEffect(() => {
    const elements = document.querySelectorAll(".how-it-works-mobile-reveal");
  ...
  return (
    <div className="relative flex flex-col overflow-hidden bg-primary/5 md:p-24">
      <div className="how-it-works-mobile-reveal absolute inset-0 hidden bg-[url('/images/howitworks-bgsection.webp')] bg-cover bg-center bg-no-repeat md:block" />
      <div className="relative md:hidden">
        <img
          src="/images/howitworks-bgsection.webp"
          alt=""
          className="how-it-works-mobile-reveal h-[80vh] w-full object-cover object-right-top"
        />
